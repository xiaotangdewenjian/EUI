...
// 自己unitId
	...
	public partial class A2C_CreateRole: Object, IResponse
	{
		...
		[ProtoMember(1)]
		public RoleInfoProto RoleInfostruct { get; set; }
	...
	public partial class A2C_GetRealmKey: Object, IResponse
	{
		...
		[ProtoMember(5)]
		public string RealmKeyAddress { get; set; }
	...
	[ResponseType(nameof(G2C_MyEnterGame))]
	[Message(OuterOpcode.C2G_MyEnterGame)]
	[ProtoContract]
	public partial class C2G_MyEnterGame: Object, IRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.G2C_MyEnterGame)]
	[ProtoContract]
	public partial class G2C_MyEnterGame: Object, IResponse
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
